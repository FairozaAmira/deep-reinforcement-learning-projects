...
1. Download and install the necessary libraries by following the instruction in [this Udacity DRLND link](https://github.com/udacity/deep-reinforcement-learning#dependencies)
...
3. Noise is added using an Ornstein-Uhlenbeck process (as recommended in the paper) where theta and sigma were set as 0.15 and 0.2, respectively. 
4. Two agents share a replay buffer so that their experience is combined with training.

`Report.ipynb` contained the details of the experiment.
